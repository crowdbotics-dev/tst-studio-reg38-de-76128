...
const Untitled2 = () => {
  ...
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }} style={styles.pMuBuIap}><ImageBackground style={styles.oOsKgePx} source={require("./Screenshot_2.png")} resizeMode="cover"></ImageBackground><ImageBackground style={styles.CBwhjrvB} source={{
      ...
      }} resizeMode="cover"><View style={styles.cFJauuZq}></View></ImageBackground><View style={styles.oTGgmrqE}></View><View style={styles.bZVDmBuz}></View></ScrollView>
    </SafeAreaView>;
};
